...
:ref:`Journée en l'honneur de Jean-Pierre Hansen <hansen>` |br|
...
:ref:`Journées du Centre Blaise Pascal - Data Analysis and Modeling in Life Sciences <jcbpamd>` |br|
**November 28, 2013** |br|
...
:ref:`Workshop on Numerical Modelling of Grains/Fluid Flows <wnmgff>` |br|
...
:ref:`Inauguration de la nouvelle plateforme de calcul de la FLMSN <inpc>` |br|
...
:ref:`Efficient solution of large systems of non-linear PDEs in science <eslsnlpde>` |br|
**October 7-9, 2013** |br|
Centre Blaise Pascal, ENS Lyon, France 
...
:ref:`Geoturb: Numerical Modeling and theoretical challenges in atmosphere and ocean turbulence <gnmtcaot>` 
...
:ref:`Influence of Interfacial Interactions on Structural and Rheological Properties of Confined Liquids <iiisrpcl>` 
...
:ref:`Journées de Physique Mathémathique Lyon: Topological insulators <jpmlti>` |br|
...
:ref:`Shocks, Reconnection, and Particle Acceleration in Plasma-fluids <srpapf>` |br|
**June 20-21, 2013** |br|
Centre Blaise Pascal, ENS Lyon, France 
...
:ref:`Réseau "LyonCalcul" : 2nde matinée de rencontres des acteurs du calcul à Lyon <rlyoncalcul>` |br|
...
:ref:`Colloque SIERRA : "Avancées récentes autour de l'extraction de modes" <csierras>` |br|
**March 13, 2013** |br|
