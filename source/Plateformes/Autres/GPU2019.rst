...
CBP 2019 : le GPU par la pratique
=================================

Cette session pratique accompagne le `cours <http://www.cbp.ens-lyon.fr/emmanuel.quemener/documents/PresentationGPU_190606_EQ.pdf>`_ du 6 juin au matin réalisé par Emmanuel Quémener.
...
* **Quand ?** Jeudi, 6 juin 2019 de 9h à 18h
...
En cas de difficultés, appliquez la :ref:`recette de Gromacs pour Debian Stretch <gromacsgpuexec>` ;-)
...
--- `Emmanuel Quemener <emmanuel.quemener@ens-lyon.fr>`_ CC BY-NC-SA 2019-06-11